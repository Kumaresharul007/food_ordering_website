...
<?php
        ...
        if(isset($_POST["search"])){
          $terms = explode(" ", $_POST["key"]);
          $terms2 = array();
          $array_length = count($terms);
          for($j=0; $j<$array_length; $j++){
            $terms2[] = strtoupper($terms[$j]);
          }
          // $i=0;
          // $sql = "SELECT * FROM dishes_new WHERE name LIKE '%$terms2[0]%'";
          ...
          for($i=0; $i<$array_length; $i++){
            $sql = "SELECT * FROM dishes_2 WHERE name LIKE '%$terms2[$i]%'";
        ...
        if(!isset($_POST["search"])){
          die("Search some dishes to display in this page!");
        }
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="hero">
    ...
    <div align="center">
      <div style="margin-top: 100px;" class="row">
        <h1 style="color: darkorange;">SEARCH RESULTS:</h1>
      </div>
    </div>
  </div>
  <?php if($error != " "){ ?>
  <h2 align="center" style="color: red; margin-top: 100px;"><?php echo $error; ?></h2>
  <?php } ?>
