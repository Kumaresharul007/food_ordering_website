...
<body>
  <div class="hero">
    ...
    <div align="center">
      <div style="margin-top: 100px;" class="row">
        <h1 style="color: darkorange;">CART DISHES:</h1>
      </div>
    </div>
  </div><br>
  <?php if(isset($_SESSION["cart"])){ ?>
  <form align="center" action="cart.php" method="post">
      <input class="btn btn-secondary" type="submit" name="remove" value="Delete cart history">
  </form><br>
  <?php
      $arr = $_SESSION["cart"];
  ...
  <div class="container cart">    
    <?php
      ...
      $sql = "SELECT * FROM dishes_2 WHERE name='$arr[$j]'";
    ...
    <div class="card" style="width: 20rem;">
      <a href="dishdetail.php?name=<?php echo $dishname; ?>"><img class="card-img-top" src="assets/images/<?php echo $dishimage; ?>" alt="Card image cap"></a>
      <div class="card-body">
        <h5 class="card-title">
        ...
        <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <button type="submit" name="addtoorders" value="orders" style="width: 100%;" class="btn btn-success">Buy now</button><br><br>
        </form>
        <?php 
  ...
  <?php } ?>
  <?php if(!isset($_SESSION["cart"])){ ?>
    <h3 align="center" style="color: red;">Your cart is empty!</h3>
    <div align="center">
    <lottie-player src="https://assets9.lottiefiles.com/temp/lf20_jzqS18.json" background="transparent" speed="1" style="width: 500px; height: 500px;" loop autoplay></lottie-player>
